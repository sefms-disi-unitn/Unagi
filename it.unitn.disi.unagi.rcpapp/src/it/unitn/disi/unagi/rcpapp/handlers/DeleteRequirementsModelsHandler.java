...
/**
 * Handler for the "Delete Requirements Model" command.
 * 
 * @author Vitor E. Silva Souza (vitorsouza@gmail.com)
 * @version 1.0
 */
public class DeleteRequirementsModelsHandler extends AbstractRequirementsModelsHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell activeShell, ESelectionService selectionService) {
		...
		// Confirms the deletion of the models.
	...
	protected void doExecute(IProgressMonitor monitor, IFile model) throws UnagiException {
		// Delegates to the application class the deletion of the given model.
		manageModelsService.deleteRequirementsModel(monitor, model);
	}
}
