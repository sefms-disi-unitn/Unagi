...
import it.unitn.disi.unagi.rcpapp.wizards.CreateNewRequirementsModelWizard;
...
/**
 * Handler for the "New Requirements Model" command.
 * 
 * @author Vitor E. Silva Souza (vitorsouza@gmail.com)
 * @version 1.0
 */
public class NewRequirementsModelHandler extends AbstractProjectsHandler {
	/**
	 ...
	 * @param wizard
	 *          A Create New Requirements Model wizard that will be automatically created and injected by the DI
	 *          mechanism.
	 */
	@Execute
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell activeShell, CreateNewRequirementsModelWizard wizard) {
		LogUtil.log.debug("Executing \"New Requirements Model\" command."); //$NON-NLS-1$

		// Opens the "Create new requirements model" wizard that was created and injected automatically by Eclipse.
	...
	public boolean canExecute(ESelectionService selectionService) {
		// Can only create new model if a single element of the project tree in the project explorer is selected.
